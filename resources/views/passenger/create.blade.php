...
<div class="container w-50">
	<div class="card">
	  <div class="card-body">
	    ...
	    <form action="{{ route('passenger.insert') }}" method="POST">
	    	...
	    	<div class="form-group mt-2">
	    		<div class="row">
	    			<div class="col-md-6">
	    				...
	    				<input type="date" name="travel_date" class="form-control @error('travel_date') is-invalid @enderror" value="{{ old('travel_date') }}">
	    			...
	    			<div class="col-md-6">
	    				...
	    				<select name="outbound_flight" class="form-control @error('outbound_flight') is-invalid @enderror">
	    					...
	    					<option value="{{ $flight->id }}" @if(old('outbound_flight') == $flight->id) selected @endif>{{ $flight->flightString() }}</option>
	    					@endforeach
	    				</select>
	    		...
	    		<div class="row">
	    			...
	    			<div class="col-md-6">
	    				...
	    				<select name="inbound_flight" class="form-control @error('inbound_flight') is-invalid @enderror">
	    					...
	    					<option value="{{ $flight->id }}" @if(old('inbound_flight') == $flight->id) selected @endif>{{ $flight->flightString() }}</option>
	    					@endforeach
	    				</select>
	    	...
	    	<div class="form-group mt-2">
	    		...
	    		<textarea name="notification" class="form-control @error('notification') is-invalid @enderror" rows="5" required>{{ old('notification') }}</textarea>
	    	</div>
